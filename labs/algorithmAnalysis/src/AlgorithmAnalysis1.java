...
public class AlgorithmAnalysis1 {
    public static void main(String[] args) {

        // We will create an ArrayList of random integers
        // And then call index of method through the getIndexOfTime method
        int[] items = {10000, 20000, 30000, 40000, 50000};
